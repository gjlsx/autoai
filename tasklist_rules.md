...
# build a tasklist must doing this structure:
  0. tasklist name like: `tasklist03172314.md`  ## `tasklistMMDDhhmm.md`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| todo| t0316.p10 | demo-project | Add schema sync command | Add idempotent schema sync entrypoint and tests | feature | P0 | codex || |front ||  |  |  |  |
| todo| t0316.p11 | demo-project | Write migration docs | Document migration usage and rollback notes | docs | P1 | claude |  | t0316.p10 | todo | back |  |  |  |  | |
